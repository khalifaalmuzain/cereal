...
urlpatterns = [
	...
	url(r'^get_cereal_manufacturer_search/$', 'main.views.get_cereal_manufacturer_search'),
    url(r'^manu_list_view/$', 'main.views.manu_list_view'),
	url(r'^manu_search/(?P<manufacturer>\w+)/$', 'main.views.manu_search'),
